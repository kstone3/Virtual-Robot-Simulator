...
//    DistanceSensor sensorDistance;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        frm = hwMap.get(DcMotor.class, "front_right_motor");
        flm = hwMap.get(DcMotor.class, "front_left_motor");
        rrm = hwMap.get(DcMotor.class, "back_right_motor");
        rlm = hwMap.get(DcMotor.class, "back_left_motor");
