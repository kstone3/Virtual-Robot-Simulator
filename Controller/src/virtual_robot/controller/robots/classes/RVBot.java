 ...
 */
@BotConfig(name = "Robovine Bot", filename = "rv_bot")
public class RVBot extends VirtualBot {
    ...
    public RVBot() {
        ...
        INTER_WHEEL_WIDTH = botWidth * 15.0 / 18.0;
        INTER_WHEEL_LENGTH = botWidth * 13.0 / 18.0;
